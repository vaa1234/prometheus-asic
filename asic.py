...
class AppMetrics:
    ...
    async def collect(self):
        ...
        for asic_ip, properties in self.data.items():
            ...
            self.add_or_update_metric('miner_temperature_left_board_temperature', base_labels, properties['devs']['DEVS'][2]['Temperature'])
            self.add_or_update_metric('miner_temperature_left_board_chip_avg_temperature', base_labels, properties['devs']['DEVS'][2]['Chip Temp Avg'])
            ...
            self.add_or_update_metric('miner_temperature_right_board_temperature', base_labels, properties['devs']['DEVS'][0]['Temperature'])
            self.add_or_update_metric('miner_temperature_right_board_avg_chip_temperature', base_labels, properties['devs']['DEVS'][0]['Chip Temp Avg'])
